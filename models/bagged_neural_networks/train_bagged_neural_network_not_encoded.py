...
def train_bagged_neural_networks(
    ...
    train_path = os.path.join(script_dir, "..", "..", DATASET_FOLDER_NAME,
                              f"{TRAIN_DATASET_PREFIX}_{CLEANED_DATASET_NAME}.csv")
    validation_path = os.path.join(script_dir, "..", "..", DATASET_FOLDER_NAME,
                                   f"{VALIDATION_DATASET_PREFIX}_{CLEANED_DATASET_NAME}.csv")
    test_path = os.path.join(script_dir, "..", "..", DATASET_FOLDER_NAME,
                             f"{TEST_DATASET_PREFIX}_{CLEANED_DATASET_NAME}.csv")
...
if __name__ == "__main__":
    ...
    torch.save(model.state_dict(), os.path.join(script_dir, f"{BAGGED_NN_MODEL_FILENAME}_not_encoded_state_dict.pth"))
