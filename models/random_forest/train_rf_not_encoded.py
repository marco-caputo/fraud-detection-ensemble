...
def train_random_forest(model_name: str = "RF", n_estimators: int = N_FEATURES, max_depth=RF_MAX_DEPTH,
...
if __name__ == "__main__":
    ...
    joblib.dump(rf, os.path.join(script_dir,f"{RANDOM_FOREST_MODEL_FILENAME}_not_encoded.joblib"))
    print(f"Random Forest model successfully saved {RANDOM_FOREST_MODEL_FILENAME}_not_encoded.joblib in the current directory.")