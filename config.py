...
OUTLIER_DATASET_NAME = "outlier_dataset"                # Name of the outlier dataset file
ENCODED_DATASET_NAME = "encoded_dataset"                # Name of the encoded dataset file
ENCODED_OUTLIER_DATASET_NAME = "encoded_outlier_dataset"   # Name of the encoded outlier dataset file
